  ...
  },
  {
    ...
    basicPlan: {
      ...
      coverageList: [
        ...
        { code: 'AM', name: 'Asistencia Médica', limit: '$500.00 / $2,500.00', prima: 9 },
        { code: 'MA', name: 'Muerte Accidental', limit: '$2,000.00', prima: 0 },
      ],
      endosoBenefits: [
        'Asistencia vial limitada incluida',
        'Coordinación de envío de ambulancia',
        'Transmisión de mensajes urgentes',
      ],
    ...
    premiumPlan: {
      ...
      coverageList: [
        { code: 'LC', name: 'Lesiones Corporales', limit: '$25,000.00 / $50,000.00', prima: 40.50 },
        { code: 'DPA', name: 'Daños a la Propiedad Ajena', limit: '$25,000.00', prima: 72 },
        { code: 'AM', name: 'Asistencia Médica', limit: '$2,000.00 / $10,000.00', prima: 15.75 },
        { code: 'MA', name: 'Muerte Accidental', limit: '$2,000.00', prima: 0 },
