  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 sm:py-10" ref={formRef}>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {step < TOTAL_STEPS ? (
          <button type="button" onClick={goNext} className="flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold text-white bg-[#8AAA19] hover:bg-[#6d8814] transition-colors shadow-lg">
