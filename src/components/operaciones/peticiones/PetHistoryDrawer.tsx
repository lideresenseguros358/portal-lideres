...
import { fmtDateTime } from './pet-helpers';

// ════════════════════════════════════════════
// HISTORY DRAWER — Peticiones
// ════════════════════════════════════════════
...
export default function PetHistoryDrawer({ open, onClose, caseId }: Props) {
  ...
  useEffect(() => {
    ...
    (async () => {
      setLoading(true);
      try {
        const res = await fetch(`/api/operaciones/petitions?view=history&case_id=${caseId}`);
