    ...
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="px-4 pt-4 pb-3 border-b border-gray-100 space-y-2.5 flex-shrink-0">
        <div className="flex items-center justify-between">
          <h2 className="text-sm font-semibold text-[#010139] tracking-tight">Peticiones</h2>
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Buscar cliente, ticket, correo..."
            value={search}
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {/* Status dropdown */}
          <select
            value={PETITION_STATUSES.includes(activeFilter as OpsCaseStatus) ? activeFilter : ''}
      ...
      <div className="flex items-center gap-4 px-4 py-1.5 border-b border-gray-50 bg-gray-50/50 text-[10px] flex-shrink-0">
        ...
        <span className="inline-flex items-center gap-1.5 text-gray-400">
          <span className="w-1.5 h-1.5 rounded-full bg-blue-400" /> Gest <strong className="text-gray-600">{counts.en_gestion || 0}</strong>
        </span>
        <span className="inline-flex items-center gap-1.5 text-gray-400">
          <span className="w-1.5 h-1.5 rounded-full bg-teal-400" /> Env <strong className="text-gray-600">{counts.enviado || 0}</strong>
        </span>
        <span className="inline-flex items-center gap-1.5 text-gray-400">
            ...
            {cases.map((c) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Row 2: subline — email · ramo · ticket */}
