...
function MetricsBar({ counts }: { counts: Counts }) {
  const metrics = [
    ...
    { label: 'En Gestión', value: counts.en_gestion || 0, color: 'text-blue-600', bg: 'bg-blue-50' },
    { label: 'Enviados', value: counts.enviado || 0, color: 'text-teal-600', bg: 'bg-teal-50' },
    ...
    { label: 'Cerrados', value: counts.cerrado || 0, color: 'text-green-600', bg: 'bg-green-50' },
    { label: 'Perdidos', value: counts.perdido || 0, color: 'text-red-600', bg: 'bg-red-50' },
  ];
