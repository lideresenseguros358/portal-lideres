  ...
  return (
    <div className="tab-pane">
      ...
      <div className="add-rule-form">
        ...
        <input type="text" placeholder="Aliases (separados por coma)" value={newRule.aliases} onChange={e => setNewRule({...newRule, aliases: e.target.value})} />
      ...
      <style>{`
        ...
        .add-rule-form { display: grid; grid-template-columns: 1fr 2fr auto; gap: 16px; margin-bottom: 24px; }
