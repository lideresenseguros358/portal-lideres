-- =====================================================
-- FIX: Agregar CAST explícito de status a policy_status_enum
-- =====================================================
-- Problema: temp_client_import.status es TEXT
--           policies.status es policy_status_enum
-- Solución: Agregar ::policy_status_enum en el INSERT
...
BEGIN
  ...
  INSERT INTO policies (
    ...
    new_client_id,                                           -- ✅ Usar new_client_id (NO v_client_id)
    temp_record.broker_id,
    ...
    COALESCE(UPPER(temp_record.status), 'ACTIVA')::policy_status_enum  -- ✅ CAST EXPLÍCITO
  )
